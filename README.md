...
I have not (and can not) fully test all possible configurations, so I can not guarantee you won't find some irregularities with some configurations. I recommened plotting the ∆𝜎 and ∆(∆𝜎) [or ∆z and ∆(∆z)] to check for irregulaties before you use the profiles in a numerical weather prediction model.
